use crate::params::{CRYPTO_SECRETKEYBYTES, CRYPTO_PUBLICKEYBYTES, SPX_BYTES};
use crate::sign::*;

#[derive(Copy, Clone)]
pub struct Keypair {
  public: [u8; CRYPTO_PUBLICKEYBYTES],
...
/// assert!(sig.len() == SPX_BYTES);
/// ```  
pub fn sign(msg: &[u8], keypair: &Keypair) -> [u8; SPX_BYTES] 
{
